          ...
          <BlurFade delay={BLUR_FADE_DELAY * 13}>
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  We&apos;re building our own SaaS products at{" "}
                  <span className="font-semibold">Nightcoders</span> -{" "}
                  {DATA.building.length}+ so far. Some are tools like Copi,
                  others are full platforms. Everything we launch is built fast,
                  with purpose, and used by real people.
                </p>
              </div>
            </div>
          </BlurFade>
